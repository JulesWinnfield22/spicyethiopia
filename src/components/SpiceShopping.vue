<template>
  <section class="py-16 bg-white">
    <div class="container mx-auto px-4">
      ...
      <!-- Wishlist -->
      <button class="mt-12 font-sans bg-black text-white px-4 py-2 rounded-full flex justify-center items-center cursor-pointer mx-auto gap-2">
        Wishlist
      </button>
    </div>
  </section>
  ...
  computed: {
    filteredSpices(): Spice[] {
      return this.selectedCategory === 'All'
        ? this.spices
        : this.spices.filter((s: Spice) => s.category === this.selectedCategory);
    },
  },
  methods: {
