...
function setRef(el: any) {
  dropdownWrapper.value = el as HTMLElement;
}
...
<template>
  <div @click.prevent.stop="() => {}" class="relative inline-flex">
    <slot :open="openDropdown" :toggle="toggle" :setRef="setRef" />
  </div>
</template>
