        ...
        <div class="space-y-4">
          ...
          <div class="space-y-1">
            <button
              ...
              :aria-expanded="isDropdownOpen('analytics').toString()"
            >
              ...
              <svg class="ml-2 h-5 w-5 transform transition-transform duration-200" :class="isDropdownOpen('analytics') ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
              </svg>
            </button>
            <div v-if="isDropdownOpen('analytics')" class="space-y-1 pl-11">
              <a href="#" class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">Overview</a>
              <a href="#" class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">Reports</a>
              <a href="#" class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">Statistics</a>
            </div>
          </div>

          <!-- Additional menu items would be similar -->
...
export default {
  ...
  methods: {
    toggleDropdown(dropdown) {
      this.$set(this.openDropdowns, dropdown, !this.openDropdowns[dropdown]);
    },
