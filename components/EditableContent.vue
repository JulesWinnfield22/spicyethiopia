...
const canEdit = computed(() => props.editMode && isAdmin.value);
...
function updateImageValue(file: File | null | undefined) {
  ...
  <div class="relative group">
    ...
    <div v-if="type === 'text'" class="w-full">
      <div 
        v-if="!isEditing" 
        @click="startEditing"
        class="min-h-[1.5rem] rounded transition-colors"
        :class="{ 'hover:bg-gray-100 cursor-pointer p-2': canEdit }"
      >
